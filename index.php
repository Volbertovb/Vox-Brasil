            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="row colorC">
                    ...
                    <div class="col-lg-3 text-center mt-5">
											...
											<h1 class="titImg">
												Beneﬁciamento<br>
												e venda de sementes<br><br>
											</h1>

											<p class=" txtimg">
											As sementes da Caluba são produzidas em <br>
											campos de Abelardo Luz com as condições <br>
											ideais para o melhor potencial de germinação.<br><br>

											Clima e solo são excelentes, o beneficiamento <br>
											com alta tecnologia e padrões de produção ISO <br>
											9001 fazem toda a diferença. Aproveite todo o <br>
											alto grau de vigor e germinação em sua <br>
											plantação<br><br>

											Clique e entre em contato agora mesmo: <br><br><br>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 text-center mt-5">
											...
											<form name="form1" method="post" action="enviarEmail.php">
												<label>Nome</label>
